...
const PERKS = [
  'Exact macros after every workout',
  'Meal ideas that fit your budget',
  'Real products at shops near you',
]
      ...
      <div className="hidden lg:flex w-1/2 relative z-10 items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-5xl font-black leading-[1.1] tracking-tight mb-8">
            Your recovery,
            <br />
            <span className="text-shimmer">finally sorted.</span>
          </h1>
          <ul className="space-y-4">
            {PERKS.map((p, i) => (
              ...
              >
                <span className="w-6 h-6 rounded-full bg-emerald-400/15 border border-emerald-400/30 flex items-center justify-center text-emerald-400 text-xs">
                  ✓
                </span>
                {p}
              </motion.li>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-sm mb-8">
            Free forever. Upgrade anytime for €3.99/mo.
          </p>
